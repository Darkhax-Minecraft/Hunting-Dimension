        ...
        if (worldIn.getGameRules().getBoolean("doMobSpawning") && rand.nextInt(2000) < worldIn.getDifficulty().getDifficultyId()) {
            ...
            if (blockpos.getY() > 0 && !worldIn.getBlockState(blockpos.up()).isNormalCube()) {
                ...
                if (living != null) {
                    ...
                    living.setLocationAndAngles((double) blockpos.getX() + 0.5D, (double) blockpos.getY() + 1.1D, (double) blockpos.getZ() + 0.5D, MathHelper.wrapDegrees(worldIn.rand.nextFloat() * 360.0F), 0.0F);
        ...
        if (rand.nextInt(100) == 0) {
            ...
            if (living != null) {
                ...
                try {
                    ...
                    final SoundEvent sound = (SoundEvent) playSound.invoke(living);
