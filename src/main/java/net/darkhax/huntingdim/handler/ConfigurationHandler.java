...
public class ConfigurationHandler {
    ...
    public static double playerChance = 0.2;
    ...
    private void syncConfigData () {
        ...
        playerChance = config.getFloat("playerChance", Configuration.CATEGORY_GENERAL, 0.20f, 0f, 1f, "Whenever a mob dies in the hunting dimension, there is a chance that it will drop exp and items that would normally only drop if killed by a player.");
